angular.module('notesweb')
	.controller('HomeController', ['$scope','$timeout','$interval','ProgrammingService','PusherService','SendPusherService', function($scope,$timeout,$interval,ProgrammingService,PusherService,SendPusherService) {
		'use strict';
